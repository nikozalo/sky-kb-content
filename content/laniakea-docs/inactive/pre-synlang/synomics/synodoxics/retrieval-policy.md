...
These constraints cannot be violated. Any self-improvement that weakens these is [cancer-logic](../core-concepts/cancer-logic.md).
...
- **Temporal evidence weighting** — How to weight old vs recent evidence, regime detection, retroactive reweighting strategies
