...
2.2 System Overview
This system overview describes the latest received version ( Version 1 ) of the contracts as defined in the
Assessment Overview.
...
The SparkVault contract implements an ERC-4626 token with 18 decimals where the underlying asset
corresponds to a suitable ERC-20 token. So-called takers can then use the balance held by the vault as
liquidity.
