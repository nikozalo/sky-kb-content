...
composability.
The most recent audit covers the LayerZero V2 integration.
...
when they were received.
 ...
 3 2024          f05b316e                                        v1.0.0-beta.1
   07 0ct        342fe537b020ffa8ea7fcedf166b59b7ed              Fix Deployment Scripts
 4 2024          e21232
   08 0ct        52deda866ec8abdeaae9ace8574457d                 Setting USDS And sUSDS Rate Limits
 5 2024          3e4209c36
...
minted / assets withdrawn will be credited to the ALMProxy.
...
Maple: introduced in Version 11 ; only in mainnet controller.
   ...
   2. requestMapleRedemption() / cancelMapleRedemption(): withdrawals are not ERC-4626
      ...
      once the redemption is processed. Should ALMProxy be configured to manual



                    SparkDAO - Spark ALM Controller - ChainSecurity - © Decentralized Security AG      9

      withdrawal on Maple, relayers have to trigger an explicit ERC-4626 redeem() on ALMProxy to
      retrieve the tokens, which further requires a withdrawal limit being configured for the maple pool.
...
6.1 Incorrect Approval Return Decoding
...
6.2 Incorrect Slippage Protection for Curve
...
6.3 Rounding Error in Slippage Calculation
Correctness Low Version 13 Code Corrected
                                                                                                   CS-SPRKALM-009
...
6.5 Loosely Restricted Specific Calls to Arbitrary
Address
...
6.6 Mint Recipient Is Not Initialized
...
6.7 Sanity Checks In Deployment Scripts
Informational Version 3 Code Corrected
                                                                                                     CS-SPRKALM-005
